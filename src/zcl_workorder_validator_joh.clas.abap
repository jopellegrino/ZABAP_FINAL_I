CLASS zcl_workorder_validator_joh DEFINITION
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS: c_status_update TYPE zde_status_joh VALUE 'PE'.
    ...
    METHODS:
      ...
      check_customer_exists IMPORTING iv_customer_id_exist TYPE zde_customer_id_joh
